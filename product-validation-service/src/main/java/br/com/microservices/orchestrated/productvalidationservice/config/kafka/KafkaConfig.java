...
public class KafkaConfig {
    ...
    private static final Short REPLICATION_COUNT = 1;
    ...
    private String productValidationSuccessTopicName;

    @Value("${spring.kafka.topic.product-validation-fail}")
    private String productValidationFailTopicName;
    ...
    public NewTopic orchestratorTopic() {
        return buildTopic(orchestratorTopicName);
    }

    @Bean
    public NewTopic productValidationSuccessTopic() {
        return buildTopic(productValidationSuccessTopicName);
    }

    @Bean
    public NewTopic productValidationFailTopic() {
        return buildTopic(productValidationFailTopicName);
    }
}

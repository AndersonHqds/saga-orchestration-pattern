...
public class KafkaConfig {
    ...
    private String inventorySuccessTopicName;

    @Value("${spring.kafka.topic.inventory-fail}")
    private String inventoryFailTopicName;
    ...
    public NewTopic inventorySuccessTopic() {
        return buildTopic(inventorySuccessTopicName);
    }

    @Bean
    public NewTopic inventoryFailTopic() {
        return buildTopic(inventoryFailTopicName);
    }
}

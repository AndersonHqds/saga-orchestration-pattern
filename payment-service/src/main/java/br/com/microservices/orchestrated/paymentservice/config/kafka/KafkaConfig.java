...
public class KafkaConfig {
    ...
    private String paymentSuccessTopicName;

    @Value("${spring.kafka.topic.payment-fail}")
    private String paymentFailTopicName;
    ...
    public NewTopic paymentSuccessTopic() {
        return buildTopic(paymentSuccessTopicName);
    }

    @Bean
    public NewTopic paymentFailTopic() {
        return buildTopic(paymentFailTopicName);
    }
}
